...
export default function Contacts({ contacts }: ObjectProps) {
    return (
        <View
        ...
        >
            ...
            >
                {contacts.map((contact, i) => (
                    <View
                        key={i}
                        className='flex-row justify-between items-center px-3 py-4 gap-2'
                        style={{
                            backgroundColor: 'rgba(254, 242, 242, 1)'
                        }}
                    >
                        <Text
                            className='font-roboto text-primary_black'
                            style={{
                                fontSize: 13
                            }}
                        >
